...
وقتی ساختن یک شیء چیزی بیشتر از یه چند تا انتساب و یه کم منطق پشتش باشه، منطقی‌تر اینه که به جای اینکه یک کد مشابه رو چند جای برنامه تکرار کنیم؛ یه کارخونه اختصاصی براش ایجاد کنیم.
